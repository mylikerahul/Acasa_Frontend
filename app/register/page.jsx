...
const useRegister = () => {
  ...
  const handleGoogleAuth = useCallback(async (googleToken) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success("Signed in with Google successfully!", { icon: "🎉" });

        // wait a bit so cookie sets, then fast redirect
  ...
  return { register, handleGoogleAuth, loading, setLoading };
};
  ...
  <div>
    ...
    <div className="relative">
      ...
      <input
        ...
        } py-3.5 border border-slate-200 rounded-xl text-sm outline-none
  ...
  <div>
    ...
    <div className="relative">
      <select
        ...
        onChange={onChange}
        disabled={disabled}
        className="w-full px-4 py-3.5 border border-slate-200 rounded-xl text-sm 
          outline-none appearance-none bg-white text-slate-800
          focus:border-blue-400 focus:ring-2 focus:ring-blue-100
          disabled:bg-slate-50 disabled:cursor-not-allowed
          transition-all duration-200"
      >
    ...
    <div className="flex gap-2">
      ...
      <div className="relative w-28">
        <select
          ...
          disabled={disabled}
          className="w-full px-3 py-3.5 border border-slate-200 rounded-xl text-sm 
            outline-none appearance-none bg-white text-slate-800
            focus:border-blue-400 focus:ring-2 focus:ring-blue-100
            disabled:bg-slate-50 disabled:cursor-not-allowed
            transition-all duration-200"
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          disabled={disabled}
          className="w-full pl-12 pr-4 py-3.5 border border-slate-200 rounded-xl text-sm 
...
const GoogleButton = ({ onClick, disabled, loading, text = "Sign up with Google" }) => (
  <button
    type="button"
    onClick={onClick}
    disabled={disabled || loading}
    className="w-full flex items-center justify-center gap-3 px-6 py-3.5 
      bg-white border-2 border-slate-200 rounded-xl text-sm font-medium text-slate-700 
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1 text-sm">
            Join us to explore premium properties in Dubai
          </p>
        </div>
